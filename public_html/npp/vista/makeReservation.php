...
<form class="form-horizontal" action="index.php">
    ...
    <input type="hidden" name="c" value="payReservation">

    <div class="form-group">
        <label for="fecha_inicio" class="col-sm-2 control-label"><?php _t("Parking"); ?></label>
        <div class="col-sm-10">
            <input type="date" class="form-control" id="fecha_inicio" placeholder="Av. Louise 363">
        </div>
    </div>
