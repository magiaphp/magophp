...
<?php _t("Editar"); ?></h2> 
 ...
 <?php 
                        $campos = array(array(
"type" => "text",
"name" => "_actualizaciones_version",
"value" => "$_actualizaciones_version",                                                                        
    
"for" => "_actualizaciones_version",
"label" => "version",
"class" => "form-control",
"id" => "_actualizaciones_version",
"placeholder" => "version",
                    ),array(
"type" => "text",
"name" => "_actualizaciones_requiere",
"value" => "$_actualizaciones_requiere",                                                                        
    
"for" => "_actualizaciones_requiere",
"label" => "requiere",
"class" => "form-control",
"id" => "_actualizaciones_requiere",
"placeholder" => "requiere",
                    ),array(
"type" => "text",
"name" => "_actualizaciones_nombre",
"value" => "$_actualizaciones_nombre",                                                                        
    
"for" => "_actualizaciones_nombre",
"label" => "nombre",
"class" => "form-control",
"id" => "_actualizaciones_nombre",
"placeholder" => "nombre",
                    ),array(
"type" => "text",
"name" => "_actualizaciones_descripcion",
"value" => "$_actualizaciones_descripcion",                                                                        
    
"for" => "_actualizaciones_descripcion",
"label" => "descripcion",
"class" => "form-control",
"id" => "_actualizaciones_descripcion",
"placeholder" => "descripcion",
                    ),array(
"type" => "text",
"name" => "_actualizaciones_ejecutar",
"value" => "$_actualizaciones_ejecutar",                                                                        
    
"for" => "_actualizaciones_ejecutar",
"label" => "ejecutar",
"class" => "form-control",
"id" => "_actualizaciones_ejecutar",
"placeholder" => "ejecutar",
                    ),array(
"type" => "text",
"name" => "_actualizaciones_estatus",
"value" => "$_actualizaciones_estatus",                                                                        
    
"for" => "_actualizaciones_estatus",
"label" => "estatus",
"class" => "form-control",
"id" => "_actualizaciones_estatus",
"placeholder" => "estatus",
                    ),);
