...
foreach ($idiomas_disponibles as $idioma) {
    $tr = _traducciones_segun_idioma_frase($idioma,$_contenido_frase);

$btn = (_traducciones_segun_idioma_frase($idioma,$_contenido_frase))?"default":"primary";
  ...
  <button type="submit" class="btn btn-'.$btn.'">'.$idioma.' ('._tr("Registrar").')</button>
</form>';
}
