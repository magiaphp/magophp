...
<input type="hidden" name="c" value="buscar"> 
     ...
     <label for="contactos_idioma" class="col-sm-2 control-label"><?php _t("Idioma");?></label> 
       <input type="text" class="form-control" name="contactos_idioma" id="contactos_idioma" placeholder="<?php _t("Idioma"); ?> "> 
   </div> 
     <div class="form-group"> 
     <label for="contactos_tipo_documento" class="col-sm-2 control-label"><?php _t("Tipo_documento");?></label> 
     ...
     <div class="form-group"> 
     <label for="contactos_ruc_prefijo" class="col-sm-2 control-label"><?php _t("Ruc_prefijo");?></label> 
       <input type="text" class="form-control" name="contactos_ruc_prefijo" id="contactos_ruc_prefijo" placeholder="<?php _t("Ruc_prefijo"); ?> "> 
   </div> 


     <div class="form-group"> 
     <label for="contactos_numero_documento" class="col-sm-2 control-label"><?php _t("Numero_documento");?></label> 
     ...
     <div class="form-group"> 
     <label for="contactos_fax" class="col-sm-2 control-label"><?php _t("Fax");?></label> 
     ...
     <div class="form-group"> 
     <label for="contactos_es_contacto" class="col-sm-2 control-label"><?php _t("Es_contacto");?></label> 
